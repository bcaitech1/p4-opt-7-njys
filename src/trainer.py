...
class TorchTrainer:
    ...
    def test(
        ...
        score, score_f1_underfifth, score_f1_low, score_f1_high = GetScore(f1, self.model_macs)
...
def GetScore(f1, macs):

    score_max = macs / 13863553.
    if f1 < 0.5:
        score_f1 = 1
    elif f1 < 0.8342:
    ...
    return score, score_f1_underfifth, score_f1_low, score_f1_high
